...
public class SimulatorComponentItemProvider 
	...
	protected void addRequiresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimulatorComponent_requires_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimulatorComponent_requires_feature", "_UI_SimulatorComponent_type"),
				 SimulatorComponentMetamodelPackage.Literals.SIMULATOR_COMPONENT__REQUIRES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addProvidesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimulatorComponent_provides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimulatorComponent_provides_feature", "_UI_SimulatorComponent_type"),
				 SimulatorComponentMetamodelPackage.Literals.SIMULATOR_COMPONENT__PROVIDES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SimulatorComponent_type") :
