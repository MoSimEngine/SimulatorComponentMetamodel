...
public class SimulatorComponentMetamodelFactoryImpl extends EFactoryImpl implements SimulatorComponentMetamodelFactory {
	...
	public static SimulatorComponentMetamodelFactory init() {
		try {
			SimulatorComponentMetamodelFactory theSimulatorComponentMetamodelFactory = (SimulatorComponentMetamodelFactory) EPackage.Registry.INSTANCE
					.getEFactory(SimulatorComponentMetamodelPackage.eNS_URI);
