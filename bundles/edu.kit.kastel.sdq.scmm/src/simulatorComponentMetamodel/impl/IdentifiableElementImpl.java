 ...
 * </p>
 * <ul>
 *   <li>{@link simulatorComponentMetamodel.impl.IdentifiableElementImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiableElementImpl extends MinimalEObjectImpl.Container implements IdentifiableElement {
	...
	protected EClass eStaticClass() {
		return SimulatorComponentMetamodelPackage.Literals.IDENTIFIABLE_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulatorComponentMetamodelPackage.IDENTIFIABLE_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimulatorComponentMetamodelPackage.IDENTIFIABLE_ELEMENT__ID:
				return getId();
		}
