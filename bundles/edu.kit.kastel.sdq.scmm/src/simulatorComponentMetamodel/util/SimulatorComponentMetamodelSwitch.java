...
public class SimulatorComponentMetamodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimulatorComponentMetamodelPackage.SIMULATOR: {
				...
				if (result == null) result = caseNamedElement(simulator);
				if (result == null) result = caseIdentifiableElement(simulator);
			...
			case SimulatorComponentMetamodelPackage.SIMULATOR_COMPONENT: {
				...
				if (result == null) result = caseNamedElement(simulatorComponent);
				if (result == null) result = caseIdentifiableElement(simulatorComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimulatorComponentMetamodelPackage.SOURCE_FILE: {
				SourceFile sourceFile = (SourceFile)theEObject;
				T result = caseSourceFile(sourceFile);
				if (result == null) result = caseNamedElement(sourceFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimulatorComponentMetamodelPackage.SOURCE_PACKAGE: {
				SourcePackage sourcePackage = (SourcePackage)theEObject;
				T result = caseSourcePackage(sourcePackage);
				if (result == null) result = caseNamedElement(sourcePackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimulatorComponentMetamodelPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimulatorComponentMetamodelPackage.IDENTIFIABLE_ELEMENT: {
			...
			case SimulatorComponentMetamodelPackage.SOURCE_PROJECT: {
				SourceProject sourceProject = (SourceProject)theEObject;
				T result = caseSourceProject(sourceProject);
				if (result == null) result = caseNamedElement(sourceProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Source Project</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Source Project</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSourceProject(SourceProject object) {
		return null;
	}
